...
%FIXME You should use the variable snr defined above
...
a3_min = -20;
a3_max = 20;
%FIXME Why use sampFreq in setting up the grid in a1? sampFreq is for the data time series, not the grid in a1 used to plot the GLRT
%A = linspace(a1_min,a1_max,sampFreq);
A = linspace(a1_min,a1_max,100);
...
%glrtqcsig4pso.m 
%FIXME Error: dataXCb should have been timeVec.^3, not dataVec.^3
